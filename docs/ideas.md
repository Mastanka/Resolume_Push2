...
| F18 | Step sequencer (SEQ) | Drum-rack style chaser for the LED bars: up to 4 texture tracks with own ADSR, patterns, per-(track, bar) layer engine — see `docs/specs/2026-09-24-step-sequencer-design.md` | L | spec approved |
